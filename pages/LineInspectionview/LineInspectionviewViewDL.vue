  ...
  <view class="inStorage">
    ...
    <view style="box-sizing: border-box; padding: 10rpx; border: 1px solid #eee">
      ...
      <uni-row class="demo-uni-row formSty">
        ...
        <uni-col :span="12">
          <view style="display: flex; align-items: center">
            <view style="width: 90px">检测数量：{{ getByVal.nCheckQuantity }}</view>
          </view>
        </uni-col> </uni-row
      ><uni-row class="demo-uni-row formSty">
        <uni-col :span="12">
      ...
      <uni-row class="demo-uni-row formSty">
        ...
        <uni-col :span="12">
          <view class="demo-uni-col">最小值：{{ getByVal.nMinValue }}</view>
        </uni-col>
      </uni-row>
      <uni-row class="demo-uni-row formSty">
        <uni-col :span="12">
        ...
        <uni-col :span="12">
          <view class="demo-uni-col">最大值：{{ getByVal.nMaxValue }}</view>
        </uni-col>
      </uni-row>
      <uni-row class="demo-uni-row formSty">
        <uni-col :span="12">
          <view class="demo-uni-col">结果：{{ getByVal.IsOkName }}</view>
        </uni-col>
        <uni-col :span="12">
      ...
      <uni-row class="demo-uni-row formSty">
        <uni-col :span="12">
          <view class="demo-uni-col">责任人：{{ getByVal.cPARM03 }}</view>
        </uni-col>
        <uni-col :span="12">
          ...
          <view class="project">
            ...
            >
              <uni-row class="demo-uni-row">
                ...
                <uni-col :span="8">
                  <view class="demo-uni-col dark">实际值：{{ item.nCheckValue }}</view>
                </uni-col>
              </uni-row>
            </view>
          </view>
...
import { Get_S_ById_V, GetForList_S_S } from '@/api/lailiao.js'
