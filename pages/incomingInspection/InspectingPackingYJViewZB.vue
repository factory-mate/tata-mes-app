...
const clckType = (obj) => {
  if (obj.cAnalysisTypeName == '定量') {
    uni.navigateTo({
      url: '/pages/incomingInspection/InspectingPackingYJViewDL?obj=' + JSON.stringify(obj)
    })
  } else {
    uni.navigateTo({
      url: '/pages/incomingInspection/InspectingPackingYJViewDX?obj=' + JSON.stringify(obj)
    })
  }
}
const getList = () => {
