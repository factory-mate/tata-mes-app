  ...
  <view class="inStorage">
    ...
    <view class="content">
      <view class="headMain">
        ...
        >
          <!-- 搜索框 -->
          <p class="headTitle">物料编码：</p>
          <p class="headText">{{ names }}</p>
        </view>
        <view
          class="headMainItem"
          style=""
        >
          <!-- 搜索框 -->
          <p class="headTitle">物料名称：</p>
          <p class="headText">{{ codes }}</p>
        </view>
      </view>
      <view class="listMain">
        <scroll-view
          ...
          >
            <view class="wLIst">
              <uni-row class="demo-uni-row">
                ...
                <uni-col :span="16">
                  <view class="demo-uni-col dark">箱码：{{ item.cInvBarCode }}</view>
                </uni-col>
              </uni-row>
              <uni-row class="demo-uni-row">
                <uni-col :span="10">
...
import { STOCKlist } from '@/api/PDA.js'
...
onLoad((option) => {
  ...
  uid.value = option.id
  names.value = option.name
  codes.value = option.code
  GetList()
})
const setfocus = () => {
