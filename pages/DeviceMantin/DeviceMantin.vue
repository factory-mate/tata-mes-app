          ...
          >
            ...
            >
              <view class="wLIst">
                ...
                <uni-row class="demo-uni-row">
                  <uni-col :span="10">
                    <view class="demo-uni-col dark">保养人员：{{ item.cPARM02 }}</view>
                  </uni-col>
                  <uni-col :span="16">
                    <view class="demo-uni-col dark">保养时间：{{ item.dEndTime }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row">
                  <uni-col :span="12">
...
import { MantainList } from '@/api/PDA.js'
...
const GetList = () => {
  ...
  MantainList({
    ...
    dOperateDateBegin: BeginTime.value ? BeginTime.value : '',
    dOperateDateEnd: EndTime.value ? EndTime.value : ''
  }).then((res) => {
    if (res.status == 200) {
...
const goPoint = (i, index) => {
  ...
  uni.navigateTo({
    url: `/pages/DeviceMantin/WaitMantain/WaitMantain?id=${i.UID}&code=${i.cDeviceCode}&name=${i.cDeviceName}&addres=${i.cUsedAddress}&pamname=${i.cPARM01}&ccode=${i.cCode}`
  })
}
//查看
const goCheck = (i) => {
  console.log(i, '查看--------------')
  uni.navigateTo({
    url: `/pages/DeviceMantin/LOOKDevice/LOOKDevice?id=${i.UID}&code=${i.cDeviceCode}`
  })
}
//下拉
onPullDownRefresh(() => {
