            ...
            >
              <view class="wLIst">
                <uni-row class="demo-uni-row">
                  ...
                  <uni-col :span="16">
                    <view class="demo-uni-col dark">采购单号：{{ item.cCode }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row">
                  <uni-col :span="14">
                ...
                <uni-row class="demo-uni-row">
                  ...
                  <uni-col :span="16">
                    <view class="demo-uni-col dark">数量：{{ item.Rest_qty }}</view>
                  </uni-col>
                </uni-row>
...
import { BuyList } from '@/api/PDA_3.js'
...
const getWaresList = async () => {
  ...
  const res = await BuyList({
    PageIndex: currentPage.value,
    pageSize: pageSize.value,
    OrderByFileds: '',
    Conditions: queryBuilder([
      { type: 'like', key: 'cCode', val: InfosearchValue.value },
      { type: 'gt', key: 'Rest_qty', val: 0 }
    ])
  })
  if (res.status == 200) {
    uni.hideLoading()
...
const goInWare = (i) => {
  uni.navigateTo({
    url: `/pages/ToolByuInStorage/ToolBuyOpear/ToolBuyOpear?iteminfo=` + JSON.stringify(i)
  })
}
//下拉
onPullDownRefresh(() => {
