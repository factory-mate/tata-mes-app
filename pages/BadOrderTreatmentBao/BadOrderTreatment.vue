...
import { GetForPage_CheckVouch_Package, Close, GetForList } from '@/api/buliang.js'
...
const getList = () => {
  ...
  GetForPage_CheckVouch_Package(obj).then((res) => {
    uni.hideLoading()
...
const clickCL = (v) => {
  uni.navigateTo({
    url: '/pages/BadOrderTreatmentBao/BadOrderTreatmentCL?obj=' + JSON.stringify(v)
  })
}
const Check = (v) => {
  uni.navigateTo({
