      ...
      <view v-if="current === 0">
        ...
        <view class="search-wl">
          ...
          <view class="">
            ...
            <uni-row class="demo-uni-row itemTxt">
              <uni-col :span="14">
                <view class="demo-uni-col light">样品规格：{{ xiangMObj.cInvStd }}</view>
              </uni-col>
              <uni-col :span="14">
                <view class="demo-uni-col dark">检验类型：扫码取样</view>
              </uni-col>
            </uni-row>
            <uni-row class="demo-uni-row itemTxt">
              <uni-col :span="14">
                <view class="demo-uni-col light">物料编码：{{ xiangMObj.cInvCode }}</view>
              </uni-col>
              <uni-col :span="14">
...
import { GetInvInfoByBarCode, GetStandardByInvCode, Add_Laboratory } from '@/api/yang.js'
...
const clickTJ = () => {
  ...
  xiangMObj.value.nTotalQuantity = slVal.value
  xiangMObj.value.cMemo = memo.value
  let obj = {
    cPARM04: 1,
    list_body: xiangMList.value
  }
