<template>
  <view class="inStorage">
    ...
    <view style="box-sizing: border-box; padding: 0 10rpx; border: 1px solid #eee">
      ...
      <uni-row class="demo-uni-row formSty">
        <uni-col :span="12">
          <view class="demo-uni-col">指标编码：{{ getByVal.cStandardCode }}</view>
        </uni-col>
        <uni-col :span="12">
        ...
        <!-- <uni-col :span="12">
					<view style="display: flex;align-items: center;">
						...
						<view class="search-inpt" style="width: 60%;">
							<uni-easyinput type="number"  v-model="baoVal" placeholder="请输入数量" >
							</uni-easyinput>
						</view>
					</view>
				</uni-col> -->
      ...
      <uni-row class="demo-uni-row formSty">
        <uni-col :span="12">
          <view class="demo-uni-col">检验数量：{{ getByVal.nCheckQuantity }}</view>
        </uni-col>
        <uni-col :span="12">
        ...
        <!-- <uni-col :span="12">
					<view style="display: flex;align-items: center;">
						...
						<view class="search-inpt" style="width: 60%;">
							<uni-easyinput  type="number" v-model="buslVal" placeholder="请输入数量" >
							</uni-easyinput>
						</view>
					</view>
				</uni-col> -->
      ...
      <uni-row class="demo-uni-row formSty">
        <uni-col :span="12">
          <view class="demo-uni-col">备注：{{ getByVal.cMemo }}</view>
        </uni-col>
        <uni-col :span="12">
          <view class="demo-uni-col">检验值：{{ getByVal.nCheckValue }}</view>
        </uni-col>
      </uni-row>
      <uni-row class="demo-uni-row formSty">
        <uni-col :span="24">
      ...
      <!-- <view style="margin-left:80% ;margin-top: -30rpx;padding-bottom: 20rpx;">
				<button class="mini-btn" type="warn" size="mini" @click="TackPic" style="margin-top: 50rpx;">拍照</button>
			</view> -->
    </view>
  </view>
</template>
...
import {
  ...
  Del_S_S,
  Get_S_ById_V,
  GetPDA_Laboratory_Standard_Detail
} from '@/api/lailiao.js'
...
const getby = () => {
  ...
  GetPDA_Laboratory_Standard_Detail(obj).then((res) => {
    uni.hideLoading()
