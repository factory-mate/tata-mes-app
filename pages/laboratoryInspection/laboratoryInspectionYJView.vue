            ...
            <view class="project">
              ...
              >
                ...
                <uni-row class="demo-uni-row itemTxt">
                  ...
                  <uni-col :span="14">
                    <view class="demo-uni-col light">指标名称：{{ item.cStandardName }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row itemTxt">
                  <uni-col :span="14">
                  ...
                  <uni-col :span="14">
                    <view class="demo-uni-col dark">检验方式：{{ item.cCheckTypeName }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row itemTxt">
                  <uni-col :span="14">
                    <!-- <view class="demo-uni-col dark">状态：{{item.IsDecideName}}</view> -->
                  </uni-col>
                  <uni-col :span="12">
                    <button
                      class="mini-btn"
...
const zhibiao = (obj) => {
  uni.navigateTo({
    url: '/pages/laboratoryInspection/laboratoryInspectionYJViewJG?obj=' + JSON.stringify(obj)
  })
}
// list
const getXiangMa = () => {
