    ...
    <view class="content">
      ...
      <view v-if="current === 0">
        ...
        <view class="form_sty iconNode">
          ...
          <view class="form_sty_item">
            <view style="width: 60px">样品名称：</view>
            <view style="flex: 1">
              <uni-easyinput
            ...
            >
              <view>
                ...
                <uni-row class="demo-uni-row">
                  ...
                  <uni-col :span="12">
                    <view class="demo-uni-col dark">样品名称：{{ item.cInvName }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row">
                  <uni-col :span="12">
                  ...
                  <uni-col :span="12">
                    <view class="demo-uni-col dark">样品规格：{{ item.cInvStd }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row">
                  <uni-col :span="12">
                ...
                <uni-row class="demo-uni-row">
                  <uni-col :span="12">
                    <view class="demo-uni-col dark">送检日期：{{ item.dDate }}</view>
                  </uni-col>
                  <uni-col :span="12">
                    <view class="demo-uni-col dark">样品数量：{{ item.nTotalQuantity }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row">
                  <uni-col :span="8">
                    <!-- <view class="demo-uni-col dark">包数：{{item.nQuantity}}</view> -->
                  </uni-col>
                  <uni-col
                    :span="16"
                    style=""
                    ...
                    >
                      <!-- <view class="demo-uni-col dark">
												<button class="mini-btn"
													...
													type="warn" size="mini" @click="CheckDow(item)">下载</button>
											</view> -->
                      <view class="demo-uni-col dark">
                        <button
                          class="mini-btn"
...
const getList = () => {
  let val = [
    ...
    {
      cAttributeCode: 'cInvName',
      cAttributeCodeValue: form.value.cInvName ? form.value.cInvName : '',
      cConditions: 'like'
    }
  ]
  let obj = {
...
const clickJYZB = (v) => {
  uni.navigateTo({
    url: '/pages/laboratoryInspection/laboratoryInspectionView?obj=' + JSON.stringify(v)
  })
}
...
const CheckEND = (obj) => {
  uni.navigateTo({
    url: '/pages/laboratoryInspection/laboratoryInspectionYJView?obj=' + JSON.stringify(obj)
  })
}
const CheckDow = (item) => {
  console.log('下载')
