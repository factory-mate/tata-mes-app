    ...
    <uni-row class="head_row">
      <uni-col :span="16">
        <view
          ...
          "
        >
          <view style="min-width: 60px">仓库：</view>
          <up-input
            :focus="focusType"
            @blur="setfocus"
            @confirm="getXM"
      ...
      <uni-col :span="8">
        <view style="margin-left: 4px">仓库：{{ changkuData.cWareHouseName }}</view>
      </uni-col>
    </uni-row>
...
import { changKuGetForList, GetUnOutForPage } from '@/api/tuihuoXJ.js'
...
const clickView = (v) => {
  uni.navigateTo({
    url: '/pages/PurchaseReturnsShelves/PurchaseReturnsShelvesView?UID=' + v.UID
  })
}
  ...
  let val = [
    {
      ...
      cAttributeCodeValue: codeVal.value ? codeVal.value : '',
      cConditions: '='
    },
    {
      cAttributeCode: 'cWareHouseCode',
      cAttributeCodeValue: XMsearchValue.value ? XMsearchValue.value : '',
      cConditions: '='
    }
  ]
