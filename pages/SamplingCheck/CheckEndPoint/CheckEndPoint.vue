...
const GoDection = (i) => {
  if (i.cAnalysisTypeName == '定性') {
    //定性
    uni.navigateTo({
      url: '/pages/SamplingCheck/EndQuaniltyPoint/EndQuaniltyPoint?ItemInfo=' + JSON.stringify(i)
    })
  } else {
    //定量
    uni.navigateTo({
      url:
        '/pages/SamplingCheck/EndQuanilyNumPoint/EndQuanilyNumPoint?ItemInfo=' + JSON.stringify(i)
    })
  }
}
//删除
