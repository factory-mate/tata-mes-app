    ...
    <view class="content">
      <view style="margin: 0 10rpx; padding: 10px">
        ...
        <uni-row class="demo-uni-row">
          ...
          <uni-col :span="12">
            <view class="demo-uni-col dark">不良数量：{{ info?.nNoPassQuantity }}</view>
          </uni-col>
        </uni-row>
        <uni-row class="demo-uni-row">
          <uni-col :span="12">
        ...
        <uni-row class="demo-uni-row">
          ...
          <uni-col :span="12">
            <view class="demo-uni-col dark">图片1： </view>
          </uni-col>
        </uni-row>
        <uni-row class="demo-uni-row">
          <uni-col :span="12">
          ...
          <uni-col :span="12">
            <view class="demo-uni-col dark">图片2： </view>
          </uni-col>
        </uni-row>
        <uni-row class="demo-uni-row">
          <uni-col :span="12">
          ...
          <uni-col :span="12">
            <view class="demo-uni-col dark">图片3： </view>
          </uni-col>
        </uni-row>
      </view>
      <view class="listMain">
...
import { GetListBYMIDSS } from '@/api/Quanilty.js'
