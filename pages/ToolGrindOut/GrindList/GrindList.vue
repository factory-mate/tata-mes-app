      ...
      <view class="listMain">
        ...
        >
          <view style="margin: 10px; font-size: 14px">
            ...
            <uni-row class="demo-uni-row">
              <uni-col :span="12">
                <view class="demo-uni-col dark">数量：{{ DevList?.nQuantity }}</view>
              </uni-col>
              <uni-col :span="12">
          ...
          <view v-if="!DevList?.list_bodys.length">暂无出库数据！</view>
          <view
            class="project"
            v-for="(item, index) in DevList?.list_bodys"
            :key="index"
          >
            <view class="wLIst">
              <uni-row class="demo-uni-row">
          ...
          <uni-load-more
            :status="more"
            v-if="DevList?.list_bodys.length"
          ></uni-load-more>
        </scroll-view>
      </view>
    </view>
...
import { GetAreadyOut } from '@/api/PDA.js'
