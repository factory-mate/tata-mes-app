          ...
          >
            ...
            >
              <view>
                ...
                <uni-row class="demo-uni-row">
                  <uni-col :span="12">
                    <view class="demo-uni-col dark">类型：{{ item.cPARM03Name }}</view>
                  </uni-col>
                  <uni-col :span="12">
                    <view class="demo-uni-col dark">仓库：{{ item.cWareHouseName }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row">
                  <uni-col :span="12">
                ...
                <uni-row class="demo-uni-row">
                  <uni-col :span="8">
                    <view class="demo-uni-col dark">包数：{{ item.PackageCount }}</view>
                  </uni-col>
                  <uni-col
                    :span="16"
                    style=""
            ...
            >
              <view>
                ...
                <uni-row class="demo-uni-row">
                  ...
                  <uni-col :span="12">
                    <view class="demo-uni-col dark">供应商名称：{{ item.cInvBatch }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row">
                  <uni-col :span="12">
                ...
                <uni-row class="demo-uni-row">
                  ...
                  <uni-col :span="12">
                    <view class="demo-uni-col dark">检验结果：{{ item.cCheckResultTypeName }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row">
                  <uni-col :span="12">
