...
import { GetForList_S } from '@/api/lailiao.js'
...
const clckType = (obj) => {
  if (obj.cAnalysisTypeName == '定量') {
    uni.navigateTo({
      url: '/pages/kuIncomingInspection/InspectingPackingYJViewDL?obj=' + JSON.stringify(obj)
    })
  } else {
    uni.navigateTo({
      url: '/pages/kuIncomingInspection/InspectingPackingYJViewDX?obj=' + JSON.stringify(obj)
    })
  }
}
const getList = () => {
