  ...
  <view class="inStorage">
    ...
    <view class="ChangTarg">
      <view style="display: flex; align-items: center">
        <view style="width: 25%; margin: 0 10px">备件名称：</view>
        <view style="width: 60%">
      ...
      <view style="display: flex; align-items: center">
        <view style="width: 22%; margin: 0 10px">备件数量：</view>
        <view style="width: 75%; display: flex; align-items: center">
          <view>
            <input
              class="inputSty"
              v-model="num"
...
import { GetPart, SavePart } from '@/api/PDA.js'
...
const AddList = () => {
  ...
  let obj = {
    MID: sendItem.value.MID,
    MIDs: sendItem.value.MIDs,
