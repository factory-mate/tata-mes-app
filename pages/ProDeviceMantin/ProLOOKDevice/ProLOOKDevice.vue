...
import { GetMianItemInfo, device_vouch_file } from '@/api/PDA.js'
...
const GoPart = (i) => {
  uni.navigateTo({
    url: `/pages/ProDeviceMantin/ProLOOKPart/ProLOOKPart?id=${i.UID}`
  })
}
//指标
const ToGtagrt = (i) => {
  uni.navigateTo({
    url: `/pages/ProDeviceMantin/ProLOOKTarget/ProLOOKTarget?uid=${i.UID}&cDeviceCode=${code.value}&cProgramCode=${i.cProgramCode}`
  })
}
//文档
const GoFile = (i) => {
