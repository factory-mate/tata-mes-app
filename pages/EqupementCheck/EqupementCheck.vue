...
const goPoint = (i, index) => {
  ...
  uni.navigateTo({
    url: `/pages/EqupementCheck/PointCheck/PointCheck?id=${i.UID}&code=${i.cDeviceCode}&name=${i.cDeviceName}&addres=${i.cUsedAddress}&pamname=${i.cPARM01}&ccode=${i.cCode}`
  })
}
//查看
const goCheck = (i) => {
  console.log(i, '查看--------------')
  uni.navigateTo({
    url: `/pages/EqupementCheck/LookEquipment/LookEquipment?id=${i.UID}&code=${i.cDeviceCode}`
  })
}
//下拉
onPullDownRefresh(() => {
