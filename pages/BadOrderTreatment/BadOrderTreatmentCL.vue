  ...
  <view class="inStorage">
    ...
    <view style="box-sizing: border-box; padding: 0 10rpx; border: 1px solid #eee">
      ...
      <uni-row class="demo-uni-row formSty">
        ...
        <uni-col :span="12">
          <view class="demo-uni-col">检验包数：{{ getByVal.PackageNumer }}</view>
        </uni-col>
      </uni-row>
      <uni-row class="demo-uni-row formSty">
        <uni-col :span="12">
...
import { GetById_CheckVouch, GetForList, Submit } from '@/api/buliang.js'
...
const getby = () => {
  ...
  GetById_CheckVouch(obj).then((res) => {
    uni.hideLoading()
...
const clickCK = () => {
  ...
  if (getByVal.value.cVouchTypeCode == 4) {
    uni.navigateTo({
      url: '/pages/incomingInspection/InspectingPackingYJView?obj=' + JSON.stringify(getByVal.value)
    })
  } else {
    uni.navigateTo({
      url:
        '/pages/kuIncomingInspection/InspectingPackingYJView?obj=' + JSON.stringify(getByVal.value)
    })
  }
}
