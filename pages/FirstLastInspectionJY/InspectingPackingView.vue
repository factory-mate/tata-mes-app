<template>
  <view class="inStorage">
    ...
    <view style="box-sizing: border-box; padding: 0 10rpx; border: 1px solid #eee">
      <uni-row class="demo-uni-row formSty">
        ...
        <uni-col :span="18">
          <view style="display: flex; align-items: center">
            <view style="width: 90px">破坏性数量：</view>
            <view
              class="search-inpt"
              style="width: 60%"
            >
      ...
      >
        <!-- <uni-col :span="19" style="display: flex;align-items: center;">
					<view class="demo-uni-col">判定选项：</view>
					<view style="width: 60%;">
						<uni-section title="可搜索" type="line">
							<zxz-uni-data-select v-model="Product" filterable :localdata="Productrange" dataKey="cDictonaryName" dataValue="cDictonaryCode"
								@inputChange="inputChange" @change="PROchange" :focus="PeofocusType"
								@input="PeoFoucs" placeholder="选择"></zxz-uni-data-select>
						</uni-section>
					</view>
				</uni-col> -->
      </uni-row>
    ...
    <view class="content">
      <view v-if="current === 0">
        <!-- 搜索框 -->
        <view class="search-wl11">
          <!-- <uni-row class="demo-uni-row" style="display: flex;align-items: center;">
						<uni-col :span="14">
							<view style="display: flex; text-align: center;justify-content: start;align-items: center;">
								<view style="width:50px;">包号：</view>
								<view class="search-inpt" style="width: 80%;">
									<uni-section  title="" type="line">
										<uni-search-bar radius="100" cancelButton="none"
											@blur="setXMfocus" @confirm="getXiangMa" v-model="xmVal"
											placeholder="请输入包号" >
										</uni-search-bar>
									</uni-section>
								</view>
						...
						<uni-col :span="9">
							<button class="mini-btn" type="warn" size="mini" @click="handleScan()" style="margin-right: 10rpx;">扫描</button>
							<button class="mini-btn" type="warn" size="mini" @click="clickbao" style="">保存</button>
						</uni-col>
					</uni-row> -->
          <!-- 单个包信息 -->
          <!-- <view class="">
            ...
            <view class="project">
              ...
              >
                <uni-row class="demo-uni-row">
                  ...
                  <uni-col :span="14">
                    <view class="demo-uni-col dark">质检单号：{{ item.cPackageCode }}</view>
                  </uni-col>
                </uni-row>
                <uni-row class="demo-uni-row itemTxt">
                  <uni-col :span="14">
                    <view class="demo-uni-col dark">指标名称：{{ item.cInvName }}</view>
                  </uni-col>
                  <uni-col :span="14">
                ...
                <uni-row class="demo-uni-row itemTxt">
                  <uni-col :span="14">
                    <view class="demo-uni-col light">不良数量：{{ item.xx }}</view>
                  </uni-col>
                  <uni-col :span="14">
...
onLoad((option) => {
  ...
  nDestoryQuantity.value = routeVal.value.nDestoryQuantity
...
const zhibiao = (obj) => {
  uni.navigateTo({
    url: '/pages/FirstLastInspectionJY/InspectingPackingViewZB?obj=' + JSON.stringify(obj)
  })
}
const handleScan = () => {
  toScanCode({
...
const clickbao = () => {
  console.log(xmVal.value, 'xmVal.value')
  if (xmVal.value == '') {
    uni.showToast({
      icon: 'error',
      title: '请输入包号'
