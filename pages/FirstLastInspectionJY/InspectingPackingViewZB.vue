  ...
  <view class="inStorage">
    ...
    <view style="box-sizing: border-box; padding: 0 10rpx; border: 1px solid #eee">
      <uni-row class="demo-uni-row formSty">
        ...
        <uni-col :span="14">
          <view style="display: flex; align-items: center">
            <view style="width: 80px">破坏性数量：</view>
            <view
              class="search-inpt"
              style="width: 60%"
            >
      ...
      <view
        ...
        "
      >
        <!-- <uv-radio-group v-model="hege" placement="row" @change="radioGroup">
						<uv-radio name="true" label="合格"></uv-radio>
						<uv-radio name="false"  label="不合格"></uv-radio>
				</uv-radio-group> -->
        <!-- <button class="mini-btn" type="warn" size="mini" @click="clickSave" style="margin-left: 40%;">保存</button> -->
      </view>
    </view>
...
onLoad((option) => {
  ...
  slVal.value = routeVal.value.nDestoryQuantity
...
const clickSave = () => {
  ...
  // 	return false
  // }
  console.log(hege.value, '--hege.value')
  let obj = {
    UID: routeVal.value.UID,
    nDestoryQuantity: slVal.value,
    IsOk: hege.value,
...
const clckType = (v) => {
  if (v.cAnalysisTypeName == '定量') {
    uni.navigateTo({
      url: '/pages/FirstLastInspectionJY/InspectingPackingViewDL?obj=' + JSON.stringify(v)
    })
  } else {
    uni.navigateTo({
      url: '/pages/FirstLastInspectionJY/InspectingPackingViewDX?obj=' + JSON.stringify(v)
    })
  }
}
const getList = () => {
