...
const zhibiao = () => {
  uni.navigateTo({
    url: '/pages/FirstLastInspectionJY/InspectingPackingViewZB'
  })
}
const clickTJ = () => {
  // if(!baoVal.value){
  ...
  let obj = {
    ...
    nCheckQuantity: routeVal.value.nCheckQuantity,
...
const clickFJ = (v) => {
  ...
  // uni.navigateTo({
  // 	url: '/pages/FirstLastInspectionJY/pdf'
  // })
  // showLeft.value.open()
}
// 图片上传
