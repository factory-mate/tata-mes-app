<template>
  ...
  <view class="inStorage">
    ...
    <view class="content">
      <view class="listMain">
        <view style="margin: 10px; font-size: 14px; border-bottom: 1px solid #eee">
          <uni-row class="demo-uni-row">
            <uni-col :span="12">
              <view class="demo-uni-col dark">刀具料号：{{ Devobj.cInvCode }}</view>
            </uni-col>
            <uni-col :span="12">
              <view class="demo-uni-col dark">刀具名称：{{ Devobj.cInvName }}</view>
            </uni-col>
          </uni-row>
          <uni-row class="demo-uni-row">
            <uni-col :span="12">
              <view class="demo-uni-col dark">数量：{{ Devobj.nQuantity }}</view>
            </uni-col>
            <uni-col :span="12">
        ...
        >
          ...
          >
            <view class="wLIst">
              ...
              <uni-row class="demo-uni-row">
                <uni-col :span="12">
                  <view class="demo-uni-col dark">研磨费：{{ item.nPrice }}</view>
                </uni-col>
                <uni-col :span="12">
...
import { GetBodySingle, GetV_PDA_Repair_In } from '@/api/yanmo.js'
