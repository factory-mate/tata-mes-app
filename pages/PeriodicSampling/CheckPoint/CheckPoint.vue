...
const GoDection = (i) => {
  if (i.cAnalysisTypeName == '定性') {
    uni.navigateTo({
      url: '/pages/PeriodicSampling/QualityPonit/QualityPonit?ItemInfo=' + JSON.stringify(i)
    })
  } else {
    uni.navigateTo({
      url: '/pages/PeriodicSampling/QuanilyNumPoint/QuanilyNumPoint?ItemInfo=' + JSON.stringify(i)
    })
  }
}
//删除
